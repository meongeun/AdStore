...
import 'ad_create_fcfs.dart';
import 'ad_create_plus.dart';

class AdCreateDiscount extends StatefulWidget {
  AdCreateDiscount({Key key, this.title}) : super(key: key);
  static const String routeName1 = "/Discount";

  final String title;

  @override
  _AdCreateDiscountState createState() => _AdCreateDiscountState();
}

class _AdCreateDiscountState extends State<AdCreateDiscount> {
  void _to_fcfs() {
    Navigator.pushNamed(context, AdCreateFcfs.routeName2);
  }

  void _to_Plus() {
    Navigator.pushNamed(context, AdCreatePlus.routeName3);
  }
                ...
                Row(
                  ...
                  children: <Widget>[
                    DropdownButton<String>(
                      ...
                      onChanged: (String newValue) {
                        setState(() {
                          dropdownValueMinute = newValue;
                        });
                      },
                      items: <String>['1분', '5분', '10분']
                          .map<DropdownMenuItem<String>>((String value) {
                        return DropdownMenuItem<String>(
                          value: value,
                          child: Text(value),
                    ...
                    DropdownButton<String>(
                      value: dropdownValuePercent,
                      onChanged: (String newValue) {
                        setState(() {
                          dropdownValuePercent = newValue;
                        });
                      },
                      items: <String>['0%', '1%', '5%', '10%']
                          .map<DropdownMenuItem<String>>((String value) {
                        return DropdownMenuItem<String>(
                          value: value,
                          child: Text(value),
